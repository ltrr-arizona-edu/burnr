...
If you also need to cite a specific version of the package in R's CRAN repository. You can see this information by running `citation('burnr')` in an R session.
